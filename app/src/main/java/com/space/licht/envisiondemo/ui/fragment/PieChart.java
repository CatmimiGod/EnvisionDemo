...
//            Log.i("toRadians",(startAngle+sweepAngle/2)+"****"+Math.toRadians(startAngle+sweepAngle/2));
            ...
            if (startAngle % 360.0 >= 90.0 && startAngle % 360.0 <= 270.0) {//2 3 象限
                canvas.drawLine(pxt,pyt,pxt-120,pyt,mLinePaint);
                canvas.drawText(resToRound+"%",pxt-mTextPaint.measureText(resToRound+"%")-50,pyt-5,mTextPaint);
                canvas.drawText("Son",pxt-mTextPaint.measureText(resToRound+"%")-50,pyt+25,mTextPaint);
            }else {
                canvas.drawLine(pxt,pyt,pxt+120,pyt,mLinePaint);
                canvas.drawText(resToRound+"%",pxt+50,pyt-5,mTextPaint);
                canvas.drawText("Mother",pxt+50,pyt+25,mTextPaint);
            }
        }
